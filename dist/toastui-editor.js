...
function getHTMLRenderConvertors(linkAttribute, customConvertors) {
  ...
  if (linkAttribute) {
    convertors.link = function (_, _ref3) {
      ...
      if (entering) {
        result.attributes = _extends(_extends({}, result.attributes), linkAttribute);
      }
...
var ToastUIEditorViewer = /*#__PURE__*/function () {
  function ToastUIEditorViewer(options) {
    ...
    el.innerHTML = '';
    this.preview = new _mdPreview__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"](el, this.eventManager, this.convertor, _extends(_extends({}, rendererOptions), {}, {
      isViewer: true
    }));
...
// EXTERNAL MODULE: /Users/chowjiaying/Github/tui.editor/libs/toastmark/dist/toastmark.js
...
var codeMirrorExt_CodeMirrorExt = /*#__PURE__*/function () {
  ...
  _proto._init = function _init(options) {
    ...
    options = _extends(_extends({}, options), {}, {
      lineWrapping: true,
      theme: 'default',
      extraKeys: _extends(_extends({}, options.extraKeys), {}, {
...
// EXTERNAL MODULE: /Users/chowjiaying/Github/tui.editor/libs/squire/build/squire.js
...
// CONCATENATED MODULE: ./src/js/keyboardShortcuts.js
/**
...
function getFormattedKeyboardShortcuts(toolbarItem) {
  var _keyMaps$toolbarItem = keyMaps[toolbarItem],
      shortcut = _keyMaps$toolbarItem[0];

  if (utils_common["b" /* isMac */]) {
    return shortcut.replace('CTRL', 'Command').replace('SHIFT', 'Shift').replace('ALT', 'Option');
  }

  return shortcut.replace('CTRL', 'Ctrl').replace('SHIFT', 'Shift').replace('ALT', 'Alt');
}
...
/**
 * What I want to do: add keyboard shortcuts to the tooltips
 * Naive implementation: hardcode it in this thing
 * improvement: add a file called keyboardShortcuts, put all the keyboard shortcuts in there and reference it here.
 * another improvement: check if it's mac or windows
 *
 */
    ...
    switch (name) {
      ...
      case 'codeblock':
        toolbarItem = new toolbarButton({
          ...
          command: 'CodeBlock',
          tooltip: i18n.get('Insert CodeBlock') + " (" + getFormattedKeyboardShortcuts('codeblock') + ")",
          state: 'codeBlock'
        });
        break;
...
// EXTERNAL MODULE: /Users/chowjiaying/Github/tui.editor/libs/to-mark/dist/to-mark.js
...
function removeHtmlTags(text, symbol) {
  var symbolLength = symbol.length;
  var removedString = text.substr(symbolLength, text.length - (symbolLength * 2 + 1));
...
var appendHtmlTags = function appendHtmlTags(text, openingTag, closingTag) {
  return "" + openingTag + text + closingTag;
};
var getClosingTag = function getClosingTag(openingHtmlTag) {
...
var expandReplaceHtmlTags = function expandReplaceHtmlTags(doc, range, expandSize, checker, replacer) {
  var expendRange = getExpandedRange(range, expandSize);
  var result = false;
...
var changeSyntaxHtmlTags = function changeSyntaxHtmlTags(doc, range, openingTag, syntaxRegex, contentRegex) {
  var _doc$getCursor2 = doc.getCursor(),
      line = _doc$getCursor2.line,
      ch = _doc$getCursor2.ch;

  var selectionStr = doc.getSelection();
  var symbolLength = openingTag.length;
  var closingTag = getClosingTag(openingTag);

  var isSyntax = function isSyntax(t) {
    return syntaxRegex.test(t);
  };

  if (!(expandReplaceHtmlTags(doc, range, symbolLength, isSyntax, function (t) {
    return removeHtmlTags(t, openingTag);
  }) || replace(doc, selectionStr, isSyntax, function (t) {
    return removeHtmlTags(t, openingTag);
  }))) {
    var removeSyntaxInsideText = selectionStr.replace(contentRegex, '$1');
...
// CONCATENATED MODULE: ./src/js/markdownCommands/underline.js
/**
...
var underlineRangeRegex = /^<u>.*<\/u>$/;
var underlineContentRegex = /<u>([^~]*)<\/u>/g;
var underlineOpeningTag = '<u>';
/**
 * Underline
...
var Underline = commandManager["a" /* default */].command('markdown',
/** @lends Underline */
{
  name: 'Underline',
...
// CONCATENATED MODULE: ./src/js/wysiwygCommands/underline.js
/**
...
var underline_Underline = commandManager["a" /* default */].command('wysiwyg',
/** @lends Underline */
{
  name: 'Underline',
  keyMap: ['CTRL+U', 'META+U'],
...
/* harmony default export */ var wysiwygCommands_underline = (underline_Underline);
...
var editor_ToastUIEditor = /*#__PURE__*/function () {
  function ToastUIEditor(options) {
    ...
    this.options = extend_default()({
      ...
      toolbarItems: ['heading', 'bold', 'italic', 'underline', 'strike', 'divider', 'hr', 'quote', 'divider', 'ul', 'ol', 'task', 'indent', 'outdent', 'divider', 'table', 'image', 'link', 'divider', 'code', 'codeblock'],
    ...
    this.preview = new mdPreview["a" /* default */](this.layout.getPreviewEl(), this.eventManager, this.convertor, editor_extends(editor_extends({}, rendererOptions), {}, {
      isViewer: false,
  ...
  _proto._addDefaultCommands = function _addDefaultCommands() {
    ...
    this.addCommand(wysiwygCommands_underline);
  };
