  ...
  describe('options', () => {
    ...
    describe('toolbaritems', () => {
      it('should populate default toolbar items', () => {
        ...
        expect(toolbarItems[3].getName()).toBe('underline');
        expect(toolbarItems[4].getName()).toBe('strike');
        expect(toolbarItems[5].getName()).toBe('divider');
        expect(toolbarItems[6].getName()).toBe('hr');
        expect(toolbarItems[7].getName()).toBe('quote');
        expect(toolbarItems[8].getName()).toBe('divider');
        expect(toolbarItems[9].getName()).toBe('ul');
        expect(toolbarItems[10].getName()).toBe('ol');
        expect(toolbarItems[11].getName()).toBe('task');
        expect(toolbarItems[12].getName()).toBe('indent');
        expect(toolbarItems[13].getName()).toBe('outdent');
        expect(toolbarItems[14].getName()).toBe('divider');
        expect(toolbarItems[15].getName()).toBe('table');
        expect(toolbarItems[16].getName()).toBe('image');
        expect(toolbarItems[17].getName()).toBe('link');
        expect(toolbarItems[18].getName()).toBe('divider');
        expect(toolbarItems[19].getName()).toBe('code');
        expect(toolbarItems[20].getName()).toBe('codeblock');
      });
